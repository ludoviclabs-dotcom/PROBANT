...
import { Pause, Play, ChevronLeft, ChevronRight, X, RotateCcw } from "lucide-react";
        ...
        <>
          ...
          <div
            style={{
              ...
              boxShadow: `0 0 0 1px ${ACCENT}55, 0 0 22px ${ACCENT}55`,
              animation: "pb-pulse-ring 2s ease-out infinite",
              ["--ring-color" as string]: `${ACCENT}66`,
              transition: "all .35s cubic-bezier(.4,0,.2,1)",
              pointerEvents: "none",
            }}
          />
